              ...
              <React.Fragment key={'opacity-row-'+t}>
                ...
                <div className="flex flex-wrap gap-4">
                  {[10, 20, 30, 40, 50, 60, 70, 80, 90].map((opacity) => {
                    // Let's use the actual Badge component with a custom className to override the bg opacity, 
                    // but we need a solid text contrast.
...
// It seems "With Icons" might not exist. Let's just append it before the final closing div.
