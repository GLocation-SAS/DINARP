...
interface RolEditClientProps {
  id: string;
}

export function RolEditClient({ id }: RolEditClientProps) {
  const router = useRouter();

  const [nombreRol, setNombreRol] = useState("Coordinador SINAP");
  ...
  const [permissions, setPermissions] = useState<Record<string, boolean>>({
    "dashboard-ver": true,
    "solicitudes-ver": true,
    "solicitudes-crear": true,
    "solicitudes-editar": true,
    "solicitudes-aprobar": true,
    "servicios-ver": true,
    "servicios-crear": true,
    "servicios-editar": true,
    "monitoreo-ver": true,
    "monitoreo-exportar": true,
    "reportes-ver": true,
    ...
    "roles-ver": true,
    "roles-crear": true,
    "instituciones-ver": true,
    "configuracion-ver": true,
    "configuracion-configurar": true,
  });
      ...
      <main className="relative p-4 sm:p-6 lg:p-8 w-full space-y-6 sm:space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            {/* Columna Izquierda: Información General (5 cols) */}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    required
                    className="min-h-[120px] rounded-xl text-xs sm:text-sm resize-none leading-relaxed"
                  />
          ...
          <DialogContent variant="standard" className="max-w-[420px] rounded-3xl p-6 sm:p-8 bg-background border-border shadow-2xl text-center">
            ...
            <DialogHeader className="text-center space-y-2">
              ...
              <DialogDescription className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                La información y los permisos del rol <strong>{nombreRol}</strong> han sido actualizados satisfactoriamente.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter className="mt-4 flex flex-col sm:flex-row gap-2 w-full">
              <Button
                type="button"
                variant="primary"
                onClick={() => router.push(`/wireframes/roles/${id}`)}
