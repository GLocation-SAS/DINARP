  ...
  return (
    <div className="min-h-screen w-full bg-[#f8faff] dark:bg-background flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl w-full flex flex-col items-center">
        ...
        <div className="text-primary mb-6 drop-shadow-lg">
            <Wrench className="size-[120px] sm:size-[160px] animate-[ha-spin_20s_linear_infinite]" strokeWidth={1.5} />
        </div>
...
fs.writeFileSync('src/app/not-found.tsx', notFoundContent, 'utf8');
fs.writeFileSync('src/app/construccion/page.tsx', construccionContent, 'utf8');
